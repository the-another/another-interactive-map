...
class Blocks {
	 ...
	 * @var string
	 */
	public const CATEGORY_SLUG = 'another-interactive-map';
	...
	public static function register(): void {
		...
		$base = ANOTHER_INTERACTIVE_MAP_DIR . 'blocks';
	...
	/**
	 * Register Another Interactive Map block category.
	 *
	 * @param array                    $categories Array of block categories.
	 * @param \WP_Block_Editor_Context $context    Block editor context.
	 * @return array Modified array of block categories.
	 */
	public static function register_block_category( array $categories, $context ): array { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
		array_unshift(
			$categories,
			array(
				'slug'  => self::CATEGORY_SLUG,
				'title' => __( 'Another Interactive Map', 'another-interactive-map' ),
				'icon'  => 'location-alt',
			)
		);
