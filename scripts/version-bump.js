...
// Configuration
const MAIN_PLUGIN_FILE = 'another-interactive-map.php';
const VERSION_CONSTANT_NAME = 'ANOTHER_INTERACTIVE_MAP_VERSION';
...
try {
  execSync('composer update --lock', { cwd: rootDir, stdio: 'ignore' });
