					...
					>
						...
						{ clickAction === 'callback' && (
							<TextControl
								...
								help={ __(
									'Global window function to call on click, e.g. onMapStateClick',
									'another-interactive-map'
								) }
						...
						{ clickAction === 'webhook' && (
							<>
								<ToggleControl
									...
									help={ __(
										"Use a custom base URL instead of this site's URL.",
										'another-interactive-map'
									) }
									checked={ webhookIsExternal }
									onChange={ ( value ) =>
										setAttributes( {
											webhookIsExternal: value,
										} )
									}
									__nextHasNoMarginBottom
								/>
								...
								{ webhookIsExternal && (
									<TextControl
										...
										help={ __(
											'External base URL, e.g. https://example.com',
											'another-interactive-map'
										) }
										value={ webhookBaseUrl }
										onChange={ ( value ) =>
											setAttributes( {
												webhookBaseUrl: value,
											} )
										}
										__nextHasNoMarginBottom
									/>
								...
								<TextControl
									...
									help={ __(
										'URI path appended after the base URL, e.g. /states/',
										'another-interactive-map'
									) }
									value={ webhookPath }
									onChange={ ( value ) =>
								...
								<SelectControl
									...
									options={ [
										...
										{
											label: __(
												'Country/State Slug (e.g. us/california)',
												'another-interactive-map'
											),
